...
public class HandlerTests : TestBaseMultipleConnections
{
    ...
    [TestMethod, TargetConnections(ConnectionTypes.RepoAccessToken, ConnectionTypes.ApiToken)]
    ...
    {
        var workspaceId = new OptionalWorkspaceIdentifier { WorkspaceUuid = "{c025e168-8bea-4666-8685-03f1c5f61503}" };
        var repositoryId = new OptionalRepositoryIdentifier { RepositoryUuid = "{06eefb5d-2f7b-4677-add7-c308b406155d}" };
